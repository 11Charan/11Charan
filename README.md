...
→ [View TerraForge](https://github.com/11Charan/terraforge-urp)
...
→ [View Bachelor Thesis](https://github.com/11Charan/BachelorThesis)
...
`Cinema 4D` `DaVinci Resolve` `AI` `3D` `Motion Graphics`

→ [View RideFrame](https://github.com/11Charan/RideFrame)
...
→ [View SlideMind](https://github.com/11Charan/SlideMind)
...
> *Building things is the best way to understand how they work.*
